...
// @__NO_SIDE_EFFECTS__
function Se(e) {
  const r = /* @__PURE__ */ De(e), t = y.forwardRef((o, n) => {
    const { children: s, ...l } = o, m = y.Children.toArray(s), d = m.find(He);
    if (d) {
      ...
      return /* @__PURE__ */ b(r, { ...l, ref: n, children: y.isValidElement(f) ? y.cloneElement(f, void 0, g) : null });
    }
...
function De(e) {
  const r = y.forwardRef((t, o) => {
    ...
    if (y.isValidElement(n)) {
      const l = Je(n), m = qe(s, n.props);
      return n.type !== y.Fragment && (m.ref = o ? Be(o, l) : l), y.cloneElement(n, m);
    }
...
function He(e) {
  return y.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Ue;
}
function qe(e, r) {
  const t = { ...r };
  for (const o in r) {
    const n = e[o], s = r[o];
    /^on[A-Z]/.test(o) ? n && s ? t[o] = (...m) => {
      const d = s(...m);
      return n(...m), d;
...
const ve = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, xe = Re, Pe = (e, r) => (t) => {
  var o;
  if ((r == null ? void 0 : r.variants) == null) return xe(e, t == null ? void 0 : t.class, t == null ? void 0 : t.className);
  const { variants: n, defaultVariants: s } = r, l = Object.keys(n).map((f) => {
    const g = t == null ? void 0 : t[f], x = s == null ? void 0 : s[f];
  ...
  return xe(e, l, d, t == null ? void 0 : t.class, t == null ? void 0 : t.className);
}, le = "-", Ke = (e) => {
  const r = Ze(e), {
  ...
  let o = (n) => {
    ...
    const g = s.length === 0 ? n : n.substring(d), x = tr(g), A = x !== g, E = f && f > d ? f - d : void 0;
    return {
      modifiers: s,
  ...
  return o;
}, tr = (e) => e.endsWith(ae) ? e.substring(0, e.length - 1) : e.startsWith(ae) ? e.substring(1) : e, or = (e) => {
  ...
  for (let f = m.length - 1; f >= 0; f -= 1) {
    ...
    let N = !!C, T = o(N ? k.substring(0, C) : k);
    if (!T) {
      if (!N) {
        d = g + (d.length > 0 ? " " + d : d);
        continue;
    ...
    const H = s(A).join(":"), B = E ? H + ae : H, j = B + T;
    if (l.includes(j))
      continue;
    l.push(j);
    const L = n(T, N);
...
}, Ee = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Te = /^\((?:(\w[\w-]*):)?(.+)\)$/i, cr = /^\d+\/\d+$/, dr = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ur = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, mr = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, pr = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, fr = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, $ = (e) => cr.test(e), p = (e) => !!e && !Number.isNaN(Number(e)), I = (e) => !!e && Number.isInteger(Number(e)), oe = (e) => e.endsWith("%") && p(e.slice(0, -1)), M = (e) => dr.test(e), gr = () => !0, br = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  ur.test(e) && !mr.test(e)
), Ve = () => !1, hr = (e) => pr.test(e), vr = (e) => fr.test(e), xr = (e) => !a(e) && !i(e), yr = (e) => F(e, je, Ve), a = (e) => Ee.test(e), O = (e) => F(e, Le, br), ne = (e) => F(e, Sr, p), ke = (e) => F(e, Ge, Ve), wr = (e) => F(e, Oe, vr), Q = (e) => F(e, _e, hr), i = (e) => Te.test(e), U = (e) => W(e, Le), kr = (e) => W(e, Ar), Ce = (e) => W(e, Ge), Cr = (e) => W(e, je), zr = (e) => W(e, Oe), Y = (e) => W(e, _e, !0), F = (e, r, t) => {
  const o = Ee.exec(e);
  return o ? o[1] ? r(o[1]) : t(o[2]) : !1;
}, W = (e, r, t = !1) => {
  const o = Te.exec(e);
  return o ? o[1] ? r(o[1]) : t : !1;
}, Ge = (e) => e === "position" || e === "percentage", Oe = (e) => e === "image" || e === "url", je = (e) => e === "length" || e === "size" || e === "bg-size", Le = (e) => e === "length", Sr = (e) => e === "number", Ar = (e) => e === "family-name", _e = (e) => e === "shadow", Nr = () => {
  const e = h("color"), r = h("font"), t = h("text"), o = h("font-weight"), n = h("tracking"), s = h("leading"), l = h("breakpoint"), m = h("container"), d = h("spacing"), f = h("radius"), g = h("shadow"), x = h("inset-shadow"), A = h("text-shadow"), E = h("drop-shadow"), k = h("blur"), C = h("perspective"), N = h("aspect"), T = h("ease"), H = h("animate"), B = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], j = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], L = () => [...j(), i, a], V = () => ["auto", "hidden", "clip", "visible", "scroll"], D = () => ["auto", "contain", "none"], u = () => [i, a, d], R = () => [$, "full", "auto", ...u()], ce = () => [I, "none", "subgrid", i, a], de = () => ["auto", {
    span: ["full", I, i, a]
  }, I, i, a], q = () => [I, "auto", i, a], ue = () => ["auto", "min", "max", "fr", i, a], ee = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], _ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], P = () => ["auto", ...u()], G = () => [$, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...u()], c = () => [e, i, a], me = () => [...j(), Ce, ke, {
    position: [i, a]
  }], pe = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], fe = () => ["auto", "cover", "contain", Cr, yr, {
    size: [i, a]
  }], re = () => [oe, U, O], w = () => [
    ...
    i,
    a
  ], z = () => ["", p, U, O], J = () => ["solid", "dashed", "dotted", "double"], ge = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], v = () => [p, oe, Ce, ke], be = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    k,
    i,
    a
  ], K = () => ["none", p, i, a], X = () => ["none", p, i, a], te = () => [p, i, a], Z = () => [$, "full", ...u()];
  return {
    cacheSize: 500,
    theme: {
...
var Mr = [
  ...
  const t = /* @__PURE__ */ Se(`Primitive.${r}`), o = y.forwardRef((n, s) => {
    const { asChild: l, ...m } = n, d = l ? t : r;
    return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ b(d, { ...m, ref: s });
  });
  return o.displayName = `Primitive.${r}`, { ...e, [r]: o };
}, {}), Ir = "Label", Fe = y.forwardRef((e, r) => /* @__PURE__ */ b(
  $e.label,
  {
    ...e,
    ref: r,
...
function Xr({ children: e }) {
  return /* @__PURE__ */ b("h1", { className: "scroll-m-20 text-4xl font-extrabold tracking-tight text-balance", children: e });
}
function Zr({ children: e }) {
  return /* @__PURE__ */ b("p", { className: "leading-7 [&:not(:first-child)]:mt-6", children: e });
}
function Qr({ children: e }) {
  return /* @__PURE__ */ b("small", { className: "text-sm leading-none", children: e });
}
...
var Vr = "Separator", ze = "horizontal", Gr = ["horizontal", "vertical"], We = y.forwardRef((e, r) => {
  const { decorative: t, orientation: o = ze, ...n } = e, s = Or(o) ? o : ze, m = t ? { role: "none" } : { "aria-orientation": s === "vertical" ? s : void 0, role: "separator" };
  return /* @__PURE__ */ b(
    $e.div,
    {
      "data-orientation": s,
